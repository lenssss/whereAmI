//
//  GameMainNavigationViewController.swift
//  Whereami
//
...
class GameMainNavigationViewController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationBar.backgroundColor = UIColor.getGameColor()
        ...
        self.navigationBar.barTintColor = UIColor.getGameColor()
